...
2. Navigate to (and create, if necessary) your working directory. For example:  
```
$ mkdir sandbox
```
3. `cd` to your working directory and activate the conda environment (called 'sev'):  
```
$ cd sandbox
$ source activate sev
```
4. Download the workshop materials by running a Git clone on command line:
```
...
##### Git config
If you're going to commit anything to the repository, you'll need a GitHub account.
